...
with st.sidebar:
    opciones = option_menu("Selecciona una sección: ",['Sobre mí', 'Experiencia', 'Gráficos'] , 
        icons=['balloon','flower3', 'moon'], menu_icon="filetype-py", default_index=0)
...
if opciones == 'Sobre mí':
    ...
    col1.image("FOTO.jpg", caption='Yo en Barra de Lagoa', width=300)
    ...
    texto = """
    Soy Fiorella Sánchez Zárate. Soy de Lima y estudio Periodismo. Lo que más me gusta de la carrera es la versatilidad que me brinda en los campos de investigación que pueda tomar. En el futuro, quisiera dedicarme principalmente a temas culturales, derechos humanos y pueblos indígenas. Durante mi tiempo libre me encanta montar bicicleta y escribir.
    """
   ...
   El curso ha significado un desafío muy grande mí durante el ciclo. Sin embargo, he podido atarvesar los avances del temario con ayuda y paciencia.
    ...
    if grafico_seleccionado == 'Gráfico_1':
        ...
        st.subheader("📊 Gráfico 1: Circular")
        ...
        with open("series_favoritas.html", "r", encoding="utf-8") as f:
            html_content = f.read()
